...
It is built using [Streamlit](https://streamlit.io/).
The website is deployed on Streamlit Cloud.

## Installation

```bash
git clone https://github.com/GuriTheoChem/HUMMR-Input-Builder.git
cd hummr-input-builder
