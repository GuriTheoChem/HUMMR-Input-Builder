...
def render_implicit_solvation_block():
    ...
    select_kw(opts, "ChargeRepresentation", "ChargeRepresentation", [ "Gaussian", "PointLike"], index=0)
    ...
    # bool_kw(opts, "DoRISOMF", "DoRISOMF", default=True)
    ...
    # bool_kw(opts, "UseApproximateFock", "UseApproximateFock", default=True)
